---
label: WebRTC Protocol
---

!!!
**Note:** Browser nodes (including WebRTC support) are on the roadmap but currently on hold. DeFi features have top priority. This document describes the WebRTC protocol design that will be implemented when browser nodes are resumed.
!!!

# Warthog WebRTC Communication Protocol
